/// TODO: this is part of the original https://pub.dev/packages/basic_utils
/// However, the mentioned package have some issues with EC (particularly in encoding to pem)
/// If the changes are merged, we may use the package along with the utility classes that it offers
/// Please contact Karl from Nuxify for migration process
/// TODO: add PR related for this
...
class CryptoUtils {
  ...
  static String encodeEcPublicKeyToPem(ECPublicKey publicKey,
    ...
    algorithm.add(ASN1ObjectIdentifier.fromName(curve));
